...
public class Insult {
	...
	public static String random() {
		...
		dieText[4] = "Did your mother never told you not to use a cactus as an dildo?";
		dieText[5] = "You freaking idiot.";
		dieText[6] = "Damnit again?";
		dieText[7] = "Why did you jump?";
		dieText[8] = "You should've called the suicide hotline.";
		...
		dieText[17] = "Did your cat make you an idiot?";
		dieText[18] = "Next time you get banned!";
		dieText[19] = "Are your parents retards because you seem very special.";
		dieText[20] = "He may look like an idiot and talk like an idiot but don't let that fool you. He really is an idiot.";
		...
		dieText[24] = "I don't know what makes you so dumb but it really works.";
		dieText[25] = "Oh my God, look at you. Anyone else hurt in the accident?";
		dieText[26] = "Stupidity is something you get born with or you're just trained well.";
		dieText[27] = "Stupidity is something you get born with or is it all your practising that made you so good at it?";
		...
		dieText[56] = "I hope you got castrated as your are not allowed to breed";
		...
		dieText[67] = "You are so ugly that death him self send you back to life to get a platic";
		...
		dieText[71] = "Eew you can see his brain. Where? I dont see it, oooh nevermind its never been there.";
		dieText[72] =  "Stop dying you are harasing death";
		dieText[73] =  "Do you know why there is no body left when you die. To save ppl the truble when no one will misse you";
		dieText[74] = "I hope you can pay the fee to Charon";
		...
		dieText[92] = "No, you cant have PigZombie as bdsm partner";
		...
		dieText[103] = "That only happened because Einand hates you.";
		...
		dieText[108] = "Is it day time yet?";
			...
			dieText[126] = "One of those dicks exploded again huh? Yeah, they creep me out too...";
			...
			dieText[136] = "The giant green exploding penis found you once, he can do it again (and again).";
			...
			dieText[140] = "Thank god you died.. now we have that much less lag";
			dieText[141] = "Gtfo out. You're a waste of time and RAM";
			...
			dieText[144] = "You say \"Hugs, not drugs\" to be safe. Yet that creeper gave you a hug, and look at you now.";
			dieText[145] = "Quick, take his stuff!";
			dieText[146] = "And sheep shall trample your body";
