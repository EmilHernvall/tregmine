...
public class LumberListener implements Listener
{
    ...
    public void Lumber(BlockBreakEvent event){
        ...
        if (Integer.parseInt(durability[0]) < connectedBlocks.size()) { // Leave the player with 1 durability point
            player.sendMessage(ChatColor.RED + "You do not have enough durability to lumber axe this log");
            return;
        }
        ...
        player.sendMessage("You lumber axed a tree containing " + size + " logs!");
